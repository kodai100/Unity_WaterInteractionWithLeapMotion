...
namespace Kodai.Fluid.SPH {
    ...
    public abstract class FluidBase<T> : MonoBehaviour where T : struct {
        ...
        [SerializeField] protected NumParticlesSet particleNum = NumParticlesSet.NUM_8K;
        ...
        private static readonly int SIMULATION_BLOCK_SIZE = 1024;
        ...
        private void Update() {
            ...
            densityCoef = particleMass * 315.0f / (64.0f * Mathf.PI * Mathf.Pow(smoothlen, 9));
            gradPressureCoef = particleMass * -45.0f / (Mathf.PI * Mathf.Pow(smoothlen, 6));
            lapViscosityCoef = particleMass * Viscosity * 45.0f / (Mathf.PI * Mathf.Pow(smoothlen, 6));
        ...
        private void RunFluidSolver() {
            ...
            int kernelID = -1;
            int threadGroupsX = numParticles / SIMULATION_BLOCK_SIZE;
